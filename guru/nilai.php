            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Daftar Nilai Siswa</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                        <div class="col-sm-12">
                            <a href="tambah_nilai.php" class="btn btn-success">Tambah Data</a>
                        </div> 
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Nilai Agama dan Moral</th>
                                            <th class="border-top-0">Bahasa</th>
                                            <th class="border-top-0">Kognitif</th>
                                            <th class="border-top-0">Sosial Emosional</th>
                                            <th class="border-top-0">Seni</th>
                                            <th class="border-top-0">Motorik</th>
                                    ...
                                    <?php
                                         if (isset($_GET['id']) == 'id') {
                                            $sql = "DELETE FROM `nilai` WHERE `id`='$_GET[id]'";
                                        ...
                                        {	
                                            ...
                                            // update user data
                                            $result = mysqli_query($con, "UPDATE nilai SET nama='$nama',agama='$agama',bahasa='$bahasa',
                                            kognitif='$kognitif', sosial='$sosial', seni='$seni', motorik='$motorik' WHERE id=$id");
                                        }
                                        ...
                                        while($jadwal = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>".$jadwal['agama']."</td>";
                                            echo "<td>".$jadwal['bahasa']."</td>";
                                            echo "<td>".$jadwal['kognitif']."</td>";
                                            echo "<td>".$jadwal['sosial']."</td>";
                                            echo "<td>".$jadwal['seni']."</td>";
                                            echo "<td>".$jadwal['motorik']."</td>";
                                            echo "<td><a href='nilai.php?id=".$jadwal['id']."' class='btn btn-danger ' onclick=\"return confirm('Apakah anda yakin ingin menghapus data ini?') \">Delete</a>
                                            <a href='edit_nilai.php?id=".$jadwal['id']."' class='btn btn-success'>Edit</a></td></tr>";
                                        }
                                        ?>
