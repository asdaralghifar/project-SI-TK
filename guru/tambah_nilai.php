            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="proses-tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="agama" placeholder="Isi nilai"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="bahasa" placeholder="Isi Nilai"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Kognitif</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="kognitif" placeholder="Isi Nilai"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Sosial Emosional</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="sosial" placeholder="Isi Nilai"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Seni</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="seni" placeholder="Isi Nilai"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Motorik</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="motorik" placeholder="Isi Nilai"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" >Simpan</button>
                                            <a href="tambah_nilai.php" class="btn btn-danger">Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
