            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                        <div class="col-sm-12">
                            <a href="tambah_jadwal.php" class="btn btn-success">Tambah Data</a>
                        </div> 
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    if(isset($_POST['update']))
                                        {	
                                            ...
                                            // update user data
                                            $result = mysqli_query($con, "UPDATE jadwal SET hari='$hari',mapel='$mapel',kelas='$kelas',
                                            waktu='$waktu', guru='$guru' WHERE id=$id");
                                        }
                                        ...
                                        while($jadwal = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>".$jadwal['waktu']." WITA</td>";
                                            echo "<td>".$jadwal['guru']."</td>";
